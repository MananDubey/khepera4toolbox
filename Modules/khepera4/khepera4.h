...
//! The complete Khepera 4 robot

struct sKhepera4 {
    int robot_id; //!< ID of the robot
    struct sKhepera4DSPIC dspic; //!< dsPIC microcontroller
    struct sKhepera4Motor motor_left; //!< Left motor
    struct sKhepera4Motor motor_right; //!< Right motor
